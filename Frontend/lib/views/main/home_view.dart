        ...
        child: postVM.isLoading
            ...
            : SafeArea(
                child: Column(
                  ...
                  children: [
                    /// Bagian Following User
                    if (postVM.currentUser != null && postVM.currentUser!.followList.isNotEmpty)
                      Container(
                        height: 110,
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: postVM.currentUser!.followList.length,
                          separatorBuilder: (_, __) => const SizedBox(width: 14),
                          itemBuilder: (context, index) {
                            final user = postVM.currentUser!.followList[index].user;
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage: user.profile != null
                                          ? CachedNetworkImageProvider(
                                              "http://10.0.2.2:9000/laravel/${user.profile}")
                                          : null,

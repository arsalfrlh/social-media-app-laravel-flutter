...
class ShowReelsView extends StatefulWidget {
  const ShowReelsView(
      {required this.userId, required this.selectedPage, required this.page});
  final int userId, selectedPage;
  final String page;

  @override
  State<ShowReelsView> createState() => _ShowReelsViewState();
}

class _ShowReelsViewState extends State<ShowReelsView> {
  bool isPlaying = true;
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      reelsVM.showAllPostUser(widget.userId, widget.page, widget.selectedPage);
    });
  }
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    _action(Icons.comment, post.commentCount.toString(),
                        Colors.white, () {

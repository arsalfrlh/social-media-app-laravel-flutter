...
import 'package:sosmed/views/profile/profile_update_view.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            buildActionButton(Icons.edit, "Edit", (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ProfileUpdateView())).then((_) => userVM.currentUser("post"));
                            }),
